...
public class Jogo {
	...
	private ArrayList<Ouro> ouros = new ArrayList<Ouro>();
	 ...
	 */
	public Jogo(){
		//criando salas do Jogo
		Sala sala = new Sala();
		this.salas = sala.inicializaSalas();
		//espalhar as chaves pelas salas
		Chave chave = new Chave();
		this.chaves = chave.inicializaChaves(salas);
		//espalhar ouro pelas salas
		Ouro ouro = new Ouro();
		this.ouros = ouro.inicializaOuros(salas);
		//espalhar poçoes pelas salas
		Pocao pocao = new Pocao();
		this.pocoes = pocao.inicializaPocao(salas);
		//espalhar machado pelas salas
		Machado machado = new Machado();
		this.machados = machado.inicializaMachados(salas);		
		//espalhar trolls pelas salas
		Troll troll = new Troll();
		this.trolls = troll.inicializaTroll(salas);
		
		//inicializando o jogador
		Mochila mochila = new Mochila();
		
		this.player.setLocalizacao(salas.get(0));
		this.player.setItens(mochila);
	}
